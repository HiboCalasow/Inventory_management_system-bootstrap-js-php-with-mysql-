...
$q=mysqli_query($conn,"SELECT * from items where itemId='".@$_GET['itemId']."'");
...
<div class="card-body">
    ...
    <?php
     if(isset($_POST['save_item'])){
        ...
        $query=mysqli_query($conn,"UPDATE  items SET itemName='$itemName' , description='$description' , dateCreated='$dateCreated' where itemId='$itemId'");
